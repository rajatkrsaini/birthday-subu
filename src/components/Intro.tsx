        ...
        <div className="relative rounded-[3rem] overflow-hidden border border-white/70 bg-white/55 backdrop-blur-md shadow-2xl">
          ...
          <div className="relative px-8 md:px-12 pb-10 pt-2">
            ...
            <h2 className="text-gray-600 font-sans-body text-[12px] md:text-sm leading-relaxed tracking-wide max-w-xl mx-auto">
              I wanted you to open this on your special day, but I couldn't complete it. I know the moment is gone and
              ...
              <div className="relative inline-block">
                ...
                <h1 className="relative font-serif-title text-6xl md:text-7xl leading-[0.95] tracking-tight">
                  ...
                  <span
                    ...
                    style={{
                      color: '#111827',
                      textShadow: '0 10px 26px rgba(244,114,182,0.10), 0 18px 40px rgba(167,139,250,0.06)',
                    }}
                  >
                    Happy Birthday
                  </span>
            ...
            <div className="mt-9 flex items-center justify-center">
              <motion.div whileHover={{ scale: 1.03 }} className="relative">
                ...
                {/* lighter container */}
                <div className="relative px-8 py-6 rounded-[2.4rem] bg-white/85 border border-white shadow-md">
                  {/* crown badge */}
                  ...
                  <div className="relative inline-block text-center">
                    ...
                    {/* SINGLE text (no overlay) + girly gradient */}
                    <span className="relative font-serif-title text-5xl md:text-7xl tracking-[0.02em]">
                      <span
                        className="relative bg-clip-text text-transparent"
                        style={{
                          backgroundImage: 'linear-gradient(135deg, #f472b6 0%, #fb7185 35%, #c084fc 70%)',
