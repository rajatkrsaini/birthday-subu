      ...
      {items.map((it) => (
        ...
        >
          {it.kind === 'text' ? (
            ...
            <div className="p-2 rounded-full bg-white/60 border border-white/75">{it.icon}</div>
          )}
        </motion.div>
      ))}
    </div>
      ...
      >
        ...
        <div className="relative rounded-[3rem] overflow-hidden border border-white/70 bg-white/55 backdrop-blur-md shadow-2xl">
          ...
          <div className="absolute inset-0">
            ...
            {/* Balloons INSIDE card (behind content) */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <Balloon color="bg-pink-200/70" delay={0} left="left-[6%]" size={86} />
              <Balloon color="bg-emerald-100/70" delay={4} left="left-[18%]" size={58} />
              <Balloon color="bg-rose-100/70" delay={7} left="left-[76%]" size={70} />
              <Balloon color="bg-sky-100/70" delay={2} left="left-[56%]" size={96} />
              <Balloon color="bg-pink-100/70" delay={10} left="left-[38%]" size={62} />
              <Balloon color="bg-violet-100/70" delay={5} left="left-[88%]" size={78} />
            </div>
          ...
          <div className="relative px-8 md:px-12 pb-10 pt-2">
            ...
            <h2 className="text-gray-600 font-sans-body text-[12px] md:text-sm leading-relaxed tracking-wide max-w-xl mx-auto">
              I wanted you to open this on your special day, but I couldn't complete it. I know the moment is gone and you
                ...
                <h1 className="relative font-serif-title text-6xl md:text-7xl leading-[0.95] tracking-tight">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      textShadow:
                        '0 10px 30px rgba(244,114,182,0.18), 0 18px 46px rgba(167,139,250,0.14), 0 22px 60px rgba(251,191,36,0.10)',
                      filter: 'blur(0.35px)',
                    }}
                    aria-hidden="true"
                  >
                    ...
                    <span className="relative font-serif-title text-6xl md:text-8xl tracking-tight">
                      ...
                      <span
                        ...
                        style={{
                          color: 'rgba(255,255,255,0.0)',
                          textShadow:
                            '0 14px 40px rgba(244,114,182,0.18), 0 20px 56px rgba(167,139,250,0.14), 0 24px 70px rgba(251,191,36,0.10)',
                          filter: 'blur(0.35px)',
                        }}
                        aria-hidden="true"
                      >
            ...
            <div className="mt-8 flex justify-center">
              <div className="w-full max-w-md rounded-2xl bg-white/60 border border-white/85 p-5 text-center shadow-sm">
                <p className="text-[11px] tracking-[0.32em] uppercase text-gray-500 font-sans-body">..</p>
            ...
            <p className="mt-6 text-gray-500 text-xs font-sans-body tracking-wide text-center">...</p>
          </div>
        </div>
      </motion.div>
    </div>
